...
public class Controller {
    ...
    public void UpdateWeight(){
        ...
        totalWeight.setText("Total Carrying Capacity: " + weight);
    }
    ...
    public void submitFindByKalory(javafx.event.ActionEvent e) throws IOException, ParseException {
        ...
        if (salad.size() > 0){
            ...
            salad.findByKalory(Integer.parseInt(min),
    ...
    public void submitCreateVegetable(javafx.event.ActionEvent e) {//Покласти кнопку,
        ...
        try {
            ...
            price = 100 + new Random().nextInt() % 900;
        }

        try {
            weight = Integer.parseInt(weightField.getText());
        }catch(NumberFormatException numb){
            weight = 1 + new Random().nextInt() % 50;
        }
        ...
        try{
            QR = Integer.parseInt(qrField.getText());
               ...
               QR = 1000 + new Random().nextInt() % 9000;
        }
